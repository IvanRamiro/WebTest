...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id'])) {
    ...
    try {
        ...
        if ($application) {
            ...
            $application['employment_status_display'] = $application['employment_status'];
            
            $application['employer_name_display'] = $application['employer_name'] === 'N/A' ? 'Not Applicable' : $application['employer_name'];
            
            $application['job_position_display'] = $application['job_position'] ?: 
                ($application['employment_status'] === 'Unemployed' ? 'Not Applicable' : 'Not Provided');
            
            $application['work_duration_display'] = $application['work_duration'] ?: 
                ($application['employment_status'] === 'Unemployed' ? 'Not Applicable' : 'Not Provided');
            
            $application['work_address_display'] = $application['work_address'] ?: 
                ($application['employment_status'] === 'Unemployed' ? 'Not Applicable' : 'Not Provided');
